...
const ListRepositories: React.FC<IListRepositoriesProps> = () => {
  ...
  return (
    <div className="w-full md:w-3/4 lg:w-2/5 mx-auto my-12 p-4 bg-gray-100">
      ...
      <div className="w-full mx-auto p-2 bg-white shadow-md rounded-md">
        {data.listAppRepositories.map((repo: Repository) => {
          return (
            <div className="flex items-center w-full p-2 cursor-pointer transition ease-in duration-100 rounded-md bg-transparent text-gray-800 hover:bg-gray-100">
