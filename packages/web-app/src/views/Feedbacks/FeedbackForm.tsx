              ...
              {({ field }: FieldProps) => {
                return (
                  <div className="mb-2">
                    ...
                    <input
                      className="block bg-transparent font-semibold text-xl mt-1 text-purple-500 w-full outline-none"
              ...
              {({ field }: FieldProps) => {
                return (
                  <>
                    ...
                    <textarea
                      className="block mt-1 bg-transparent text-md text-gray-800 w-full resize-none outline-none"
